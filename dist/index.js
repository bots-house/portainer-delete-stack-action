...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield portainer.deleteStack(cfg.portainer.endpoint, stack.id);
            core.endGroup();
        }
        catch (error) {
...
class PortainerClient {
    ...
    deleteStack(endpointId, stackId) {
        return __awaiter(this, void 0, void 0, function* () {
